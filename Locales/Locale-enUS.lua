...
L["Volume"] = true
L["VolumeMsg"] = "Adjust the volume to use while fishing."
...
L["Active"] = "FishingAce is active, easy cast disabled."
L["Standby"] = "FishingAce on standby, easy cast enabled."

-- Missing translations (namespaces) in CurseForge for the following:
--L["Mouse Button"] = "Mouse Button"
--L["MouseButtonMsg"] = "Choose which mouse button to use for casting."
--L["Watch Bobber"] = true
--L["WatchBobberMsg"] = "If set, do not cast if the cursor is over the fishing bobber."
